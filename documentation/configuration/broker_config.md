...
> __`log.flush.offset.checkpoint.interval.ms`__：我们更新上次刷新的持久记录的频率，该刷新充当日志恢复点
>
...
> **`fetch.purgatory.purge.interval.requests`**：获取请求的清除间隔（以请求数为单位）
>
